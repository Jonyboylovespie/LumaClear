...
Four configurations completed the full benchmark successfully. Lumenless Default, Sodium + Gamma Utils, and Sodium + Fullbright UB are **N/A** for this release. Lumenless Default crashed during the Nether render pass before MineBench could write a report; the two Sodium-based comparisons have not been tested yet.

## Configuration links

- Iris + [Clarity 1.1.3](https://modrinth.com/shader/clarityshader/version/1.1.3)
- Sodium + [Gamma Utils](https://modrinth.com/mod/gamma-utils)
- Sodium + [Fullbright UB](https://modrinth.com/resourcepack/fullbright-ub)
...
| Sodium + Gamma Utils | N/A | N/A | N/A | N/A — not tested |
| Sodium + Fullbright UB | N/A | N/A | N/A | N/A — not tested |

## Average FPS by scene

| Scene | Sodium only | Iris + Clarity | Lumenless Vanilla | Lumenless Fullbright | Lumenless Default | Sodium + Gamma Utils | Sodium + Fullbright UB |
|---|---:|---:|---:|---:|---:|---:|---:|
| Overworld panorama | 809.8 | 611.7 | 807.7 | 809.9 | N/A | N/A | N/A |
| Overworld flythrough | 845.6 | 633.0 | 843.9 | 847.2 | N/A | N/A | N/A |
| Nether flythrough | 3,772.2 | 714.4 | 3,768.3 | 3,776.1 | N/A | N/A | N/A |
| End flythrough | 2,885.8 | 1,273.0 | 2,889.8 | 2,892.1 | N/A | N/A | N/A |
| Chunk rebuild | 818.0 | 616.5 | 816.4 | 817.3 | N/A | N/A | N/A |

## 1% low FPS by scene

| Scene | Sodium only | Iris + Clarity | Lumenless Vanilla | Lumenless Fullbright | Lumenless Default | Sodium + Gamma Utils | Sodium + Fullbright UB |
|---|---:|---:|---:|---:|---:|---:|---:|
| Overworld panorama | 492.2 | 412.8 | 488.5 | 495.7 | N/A | N/A | N/A |
| Overworld flythrough | 466.7 | 393.4 | 465.0 | 468.9 | N/A | N/A | N/A |
| Nether flythrough | 1,099.1 | 411.0 | 1,116.4 | 1,121.3 | N/A | N/A | N/A |
| End flythrough | 886.6 | 604.3 | 885.1 | 895.6 | N/A | N/A | N/A |
| Chunk rebuild | 421.5 | 344.1 | 424.8 | 410.2 | N/A | N/A | N/A |
...
| Sodium + Gamma Utils | N/A | N/A |
| Sodium + Fullbright UB | N/A | N/A |
...
- Sodium + Gamma Utils and Sodium + Fullbright UB are planned comparison configurations and remain N/A until they are benchmarked with the same MineBench suite.
